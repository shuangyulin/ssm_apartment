				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="buildingInfoAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="buildingInfo_areaObj" class="col-md-2 text-right">所在校区:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="buildingInfo_areaObj" name="buildingInfo.areaObj" class="form-control" placeholder="请输入所在校区">
							 </div>
						  </div>
						  <div class="form-group">
