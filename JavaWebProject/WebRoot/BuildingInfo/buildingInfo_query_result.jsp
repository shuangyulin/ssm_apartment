...
<div id="buildingInfo_manage_tool" style="padding:5px;">
	...
	<div style="padding:0 0 0 7px;color:#333;">
		<form id="buildingInfoQueryForm" method="post">
			宿舍名称：<input type="text" class="textbox" id="buildingName" name="buildingName" style="width:110px" />
...
<div id="buildingInfoEditDiv">
	<form id="buildingInfoEditForm" enctype="multipart/form-data"  method="post">
		...
		<div>
			...
			<span class="inputControl">
				<input class="textbox" type="text" id="buildingInfo_areaObj_edit" name="buildingInfo.areaObj" style="width:200px" />
