				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>记录编号</td><td>所在校区</td><td>宿舍名称</td><td>管理员</td><td>门卫电话</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="buildingInfo_areaObj_edit" class="col-md-3 text-right">所在校区:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="buildingInfo_areaObj_edit" name="buildingInfo.areaObj" class="form-control" placeholder="请输入所在校区">
			 </div>
		  </div>
		  <div class="form-group">
	...
	$.ajax({
		...
		success : function (buildingInfo, response, status) {
			if (buildingInfo) {
				...
				$("#buildingInfo_areaObj_edit").val(buildingInfo.areaObj);
