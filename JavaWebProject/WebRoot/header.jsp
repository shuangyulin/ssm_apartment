    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>BuildingInfo/frontlist">宿舍信息</a></li>
                <li><a href="<%=basePath %>RoomInfo/frontlist">房间信息</a></li>
                <li><a href="<%=basePath %>LiveInfo/frontlist">住宿信息</a></li>
                <li><a href="<%=basePath %>IntoType/frontlist">信息类型</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist">综合信息</a></li>
