...
public class StudentController extends BaseController {
	...
	public void list(String studentNumber,String studentName,@ModelAttribute("classInfoId") ClassInfo classInfoId,String birthday,String telephone,Integer page,Integer rows, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
		...
		List<Student> studentList = studentService.queryStudent(studentNumber, studentName, classInfoId, birthday, telephone, page);
	    /*计算总的页数和总的记录数*/
	    studentService.queryTotalPageAndRecordNumber(studentNumber, studentName, classInfoId, birthday, telephone);
	    /*获取到总的页码数目*/
	...
	public String frontlist(String studentNumber,String studentName,@ModelAttribute("classInfoId") ClassInfo classInfoId,String birthday,String telephone,Integer currentPage, Model model, HttpServletRequest request) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (studentNumber == null) studentNumber = "";
		if (studentName == null) studentName = "";
		if (birthday == null) birthday = "";
		if (telephone == null) telephone = "";
		List<Student> studentList = studentService.queryStudent(studentNumber, studentName, classInfoId, birthday, telephone, currentPage);
	    /*计算总的页数和总的记录数*/
	    studentService.queryTotalPageAndRecordNumber(studentNumber, studentName, classInfoId, birthday, telephone);
	    /*获取到总的页码数目*/
	    int totalPage = studentService.getTotalPage();
	...
	public void OutToExcel(String studentNumber,String studentName,@ModelAttribute("classInfoId") ClassInfo classInfoId,String birthday,String telephone, Model model, HttpServletRequest request,HttpServletResponse response) throws Exception {
        if(studentNumber == null) studentNumber = "";
        if(studentName == null) studentName = "";
        if(birthday == null) birthday = "";
        if(telephone == null) telephone = "";
        List<Student> studentList = studentService.queryStudent(studentNumber,studentName,classInfoId,birthday,telephone);
        ...
        for(int i=0;i<studentList.size();i++) {
        	...
        	dataset.add(new String[]{student.getStudentNumber(),student.getStudentName(),student.getSex(),student.getClassInfoId().getClassName(),student.getBirthday(),student.getZzmm(),student.getTelephone(),student.getStudentPhoto()});
        }
        /*
