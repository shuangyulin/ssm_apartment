...
public class BuildingInfoService {
    ...
    /*按照查询条件分页查询宿舍信息记录*/
    public ArrayList<BuildingInfo> queryBuildingInfo(String buildingName,int currentPage) throws Exception { 
    ...
    /*按照查询条件查询所有记录*/
    public ArrayList<BuildingInfo> queryBuildingInfo(String buildingName) throws Exception  { 
     	String where = "where 1=1";
    	if(!buildingName.equals("")) where = where + " and t_buildingInfo.buildingName like '%" + buildingName + "%'";
    ...
    /*当前查询条件下计算总的页数和记录数*/
    public void queryTotalPageAndRecordNumber(String buildingName) throws Exception {
     	String where = "where 1=1";
    	if(!buildingName.equals("")) where = where + " and t_buildingInfo.buildingName like '%" + buildingName + "%'";
